...
public class PasswordCheckerSTUDENT_Test {
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("smjacob"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("smjacobkim8633"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("Jacob8633!"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("SMJacob86333!"));
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("HelloSMJacobKim!"));
	...
	{
		assertTrue(PasswordCheckerUtility.isValidPassword("HelloSMJacobKim8633!"));
